...
se = params[1,5]
coef = params[1,4]
aic = AIC(rem_sem_mod1)
bic = BIC(rem_sem_mod1)
...
se = params[13,5]
coef = params[13,4]
aic = AIC(full_sem_mod2)
bic = BIC(full_sem_mod2)
...
se = params[1,5]
coef = params[1,4]
aic = AIC(rem_sem_mod2i)
bic = BIC(rem_sem_mod2i)
...
se = params[5,5]
coef = params[5,4]
aic = AIC(rem_sem_mod2ii)
bic = BIC(rem_sem_mod2ii)
...
se = params[17,5]
coef = params[17,4]
aic = AIC(full_sem_mod3)
bic = BIC(full_sem_mod3)
...
se = params[1,5]
coef = params[1,4]
aic = AIC(rem_sem_mod3i)
bic = BIC(rem_sem_mod3i)
...
se = params[7,5]
coef = params[7,4]
aic = AIC(rem_sem_mod3ii)
bic = BIC(rem_sem_mod3ii)
...
se = params[1,5]
coef = params[1,4]
aic = AIC(full_sem_mod4)
bic = BIC(full_sem_mod4)
...
se = params[1,5]
coef = params[1,4]
aic = AIC(rem_sem_mod4)
bic = BIC(rem_sem_mod4)
...
se = params[13,5]
coef = params[13,4]
aic = AIC(full_sem_mod5)
bic = BIC(full_sem_mod5)
...
se = params[14,5]
coef = params[14,4]
aic = AIC(rem_sem_mod5)
bic = BIC(rem_sem_mod5)
